                    ...
                    <tbody>
                        {filteredCustomers.map(customer => (
                            <tr key={customer.id}>
                                ...
                                <td>
                                    <Link href='/residence'>
                                        <Button className='btn btn-outline-primary' variant="link" style={{ textDecoration: "none" }}>Residence</Button>
                                    </Link>
                                </td>
                                <td>
                                    <Link href='/residenceAddress'>
                                    <Button className='btn btn-outline-primary' variant="link" style={{ textDecoration: "none" }}>Address</Button>
                                    </Link>
                                </td>
